...
{
    public partial class HRTeamsForm : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                MySqlDataAdapter adapter = new MySqlDataAdapter("select * from team;", connection);
        ...
        private void HRTeamsForm_Load(object sender, EventArgs e)
        {
            LoadData();
        }
