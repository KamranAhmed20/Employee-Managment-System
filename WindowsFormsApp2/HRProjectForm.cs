...
{
    public partial class HRProjectForm : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                connection.Open();
                MySqlDataAdapter adapter = new MySqlDataAdapter("select * from projects;", connection);
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------------------------
        private void HRProjectForm_Load(object sender, EventArgs e)
        {
            LoadData();
        }
